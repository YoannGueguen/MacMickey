...
namespace MacMickeyWeb.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var macContext = _context.Orders.Include(o => o.Customer);
        ...
        {
            ViewData["CustomerId"] = new SelectList(_context.Customers, "PersonId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Discount,Comments,DateCreated,DateModified,IsValidate,CustomerId,CreatedBy,UpdatedBy,UpdatedDate,CreatedDate")] Order order)
        {
